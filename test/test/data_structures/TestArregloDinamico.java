...
public class TestArregloDinamico {
	...
	public void testDarElemento() {
		...
		// Completar la prueba
		assertTrue(arreglo != null);
		assertEquals(2 * TAMANO, arreglo.darTamano()); // El arreglo deber�a tener 200 elementos presentes.
		assertEquals(2 * TAMANO, arreglo.darCapacidad()); // La capacidad maxima del arreglo se debi� dubplicar
